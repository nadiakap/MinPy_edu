# -*- coding: utf-8 -*-
"""
Created on Thu Aug 14 12:27:05 2025

@author: nadia

steps:
Generate synthetic data (Task A and Task B).

Train with SGD → measure forgetting.

Train with Kaplinsky-inspired potential-based regularization → measure retention.
"""
